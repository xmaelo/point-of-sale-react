      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <TextField
            ...
            fullWidth
            variant="standard"
            value={amountReceive ?amountReceive:0}
            onChange={(e)=>setAmountReceive(e.target.value?e.target.value:0)}
          />
          <br/>
          Montant à rembourser: {parseInt(amountReceive) != 0 ? order.price - parseInt(amountReceive) : null}
        </DialogContent>
        <DialogActions>
