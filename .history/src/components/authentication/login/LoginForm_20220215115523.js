...
export default function LoginForm() {
    ...
    onSubmit: async () => {
      ...
      if(res){
        if(formik.values.remember){
          //localStorage.setItem("credentials", JSON.stringify({username: formik.values.email, password: formik.values.password}));
        }
  ...
  return (
    <FormikProvider value={formik} style={{backgroundColor: 'red'}}>
      <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ my: 2 }}>
          ...
          <Link component={RouterLink} variant="subtitle2" to="/commande">
            Ecran de commande
          </Link>
        </Stack>
