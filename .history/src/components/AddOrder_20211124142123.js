...
export default function AddOrder(props) {
    ...
    const tables = useSelector(p => p.consommables)
    ...
    const options = tables.map((option) => {
                        ...
                        {activeStep===0&&
                            <div style={{paddingTop: '50px'}}>
                                <Autocomplete
                                    ...
                                    getOptionLabel={(option) => option.typeConsommable?.name}
                            ...
                            <div style={{paddingTop: '100px'}}>
                                <div style={{marginLeft: '25%'}}>
                                    <FormControl
                                        style={{width: '500px'}}
                                    >
                                        <InputLabel id="demo-simple-select-label">Sekectionner la table</InputLabel>
                                        <Select
