...
function Form(props) {
  ...
  async function onSaveTable(){
    try {
      setLoand(true)
      const result = await request_post("users", {name: name, password: pass, email: username, username: username})
      setName('')
      setPass("")
      setPass1("")
      setUser("")
                    ...
                    .map((row) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="right" style={{alignContent: 'center', justifyContent: 'center'}}>
