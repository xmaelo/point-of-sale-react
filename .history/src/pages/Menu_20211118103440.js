...
const icon = (
    <Paper sx={{ m: 1 }} elevation={4}>
      <Box component="form" sx={{ width: 600, height: 320, paddingLeft: 5, paddingRight: 5, paddingTop: 2 }}>
        <h4>Nouveau Menu</h4>
        <br/>
        <TextField id="outlined-basic" label="Nom" variant="outlined" style={{width: '50%'}} />
        <TextField type="number" id="outlined-basic" label="Prix" variant="outlined" style={{marginLeft: 10}} />
      </Box>
    </Paper>
  );
