            ...
            <Grid item xs={12} sm={3} md={3}>
                ...
                <Card style={{padding: '10px'}}>
                    ...
                    <span style={{fontSize: "14px", fontWeight: 'bold'}}>
                        Total:{" "} {format(renerPrice())}
                    </span>
                    <br/>
                    <span style={{fontSize: "14px", fontWeight: 'bold'}}>
                        Consommation: {" "}{format(renerPrice2())}
                    </span>
                    <br/>
                    <span style={{fontSize: "14px", fontWeight: 'bold'}}>
                        Commission: {" "}{ format((renerPrice() * commission)/100)  } 
                    </span>
                    <br/>
                    <span style={{fontSize: "14px", fontWeight: 'bold'}}>
                        Commission finale: {" "}{format(((renerPrice() * commission)/100) -  renerPrice2())}
                    </span>
                </Card>
            </Grid>
        </Grid>
