...
const TABLE_HEAD = [
    ...
    { id: 'nonfacturer', label: 'Consommé', alignRight: false },
                    ...
                    .map((row) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left">{format(price)+ ' FCFA'}</TableCell>
                          ...
                          <TableCell align="left" style={{color: 'red'}}>{row.nonfacturer ? "Oui" : ""}</TableCell>
