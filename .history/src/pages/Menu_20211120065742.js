...
function Form(props) {
    ...
    async function onSaveMenu(){
      try {
        ...
        formData.append("file", file, "food_");

        formData.append("name", name)
        formData.append("slug", "texhdhdh hhdhhdhdht")
        ...
        console.log('obx obx obx obx', formData.getAll('name'))
        //return
        const result = await request_post_with_picture("superheroes", formData)
        console.log('result result result', result)
        // setName('')
        // setPrice(0)
        // setDescription("")
